...
var utils = __webpack_require__(/*! ./utils/index.js */ "./lib/utils/index.js");
  ...
  return {
    encode: function encodeNumber(valueInput) {
      ...
      if (typeof value === 'object' && value.toString && (value.toTwos || value.dividedToIntegerBy)) {
        var _value$toString$split = value.toString(10).split('.');

        value = _value$toString$split[0];
      }

      if (typeof value === 'string' || typeof value === 'number') {
        var _String$split = String(value).split('.');

        value = _String$split[0];
      }
